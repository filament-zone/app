<!-- @migration-task Error while migrating Svelte code: can't migrate `$: sidebarState = $activeRightSideBar.state as Criterion;` to `$derived` because there's a variable named derived.
