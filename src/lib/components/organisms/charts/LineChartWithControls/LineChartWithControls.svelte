<script lang="ts">
	...
	let localToggleValue: ILineChartWithControlsProps['toggleValue']['value'] = $state();
	let localChartData: ILineChartWithControlsProps['chartData'] = $derived(
